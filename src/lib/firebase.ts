...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY || 'AIzaSyMockAPIKeyForBuildPrerender',
...
// Initialize Firebase for client-side usage, checking if already initialized
